...
const i18n: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    conceptEval: '审查 & 绩效',
    conceptEvalDesc: 'LLM 审查交付质量，支持三种评分体系（Ali 3.75 / SABCD / EM）。',
    // features
    featTitle: '功能特性',
    feat1Title: 'AI 智能规划',
    ...
    feat4Title: '绩效评价',
    feat4Desc: '三种评分体系（Ali 3.75 / SABCD / EM），AI 生成按人按任务的绩效。',
    feat5Title: '模拟交付',
  ...
  en: {
    ...
    conceptEvalDesc: 'LLM reviews deliverable quality. Three rating systems (Ali 3.75 / SABCD / EM).',
    featTitle: 'Features',
    ...
    feat4Desc: 'Three rating systems (Ali 3.75 / SABCD / EM), AI generates per-person performance scores.',
